...
const PreviewFormPage = ({formId}) => {
    ...
    return <Container fluid>
        ...
        {form.data ? <SchemaModal form={parseSubmissionSchema(form.data)} open={form.openFormSchemaSubmissionView}
                                  title={t('form.submission.schema.label', {formName: form.data.name})}
