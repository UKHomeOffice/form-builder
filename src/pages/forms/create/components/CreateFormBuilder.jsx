        ...
        <Container>
            ...
            <Form className='attached fluid segment'>
                <Form.Group widths='equal'>
                    <Form.Field>
                        <Form.Input name="title" fluid label={t('form.create.form-title.label')}
                                    placeholder={t('form.create.form-title.placeholder')} type='text'
                    ...
                    <Form.Field>
                        <Form.Input name="formName" fluid label={t('form.create.form-name.label')}
                                    placeholder={t('form.create.form-name.placeholder')} type='text'
                ...
                <Form.Group widths='equal'>
                    <Form.Field>
                        <Form.Input name="path" label={t('form.create.form-path.label')}
                                    placeholder={t('form.create.form-path.placeholder')} type='text'
                ...
                <Divider clearing/>
                <Container><PreviewFormModal form={form.json} title={form.title} open={form.displayPreview}
